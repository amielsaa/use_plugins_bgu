...
public class MultiModelTest extends TestCase{
    ...
    public void test1() throws FileNotFoundException {
        File file = new File("trunk/test/org/tzi/use/kodkod/transform/ocl/const_fail.use");
        MModel mModel;
        ...
        File f = new File("trunk/test/org/tzi/use/kodkod/transform/ocl/const.properties");
    ...
    public void test2() throws FileNotFoundException {
        File file = new File("trunk/test/org/tzi/use/kodkod/transform/ocl/const_success.use");
        MModel mModel;
        try (FileInputStream specStream = new FileInputStream(file)){
    ...
    public void test3() throws FileNotFoundException {
        File file = new File("trunk/test/org/tzi/use/kodkod/transform/ocl/multi_const_fail.use");
        MModel mModel;
        ...
        IModel model = PluginModelFactory.INSTANCE.getModel(mModel);
        File f = new File("trunk/test/org/tzi/use/kodkod/transform/ocl/multi_const.properties");
        KodkodValidateConfigurationAction cmd = new KodkodValidateConfigurationAction();
        cmd.initialize(session);
        cmd.extractConfigureAndValidate(f);
    ...
    public void test4() throws FileNotFoundException {
        File file = new File("trunk/test/org/tzi/use/kodkod/transform/ocl/multi_const_success.use");
        MModel mModel;
        MMultiModel multiModel;
        try (FileInputStream specStream = new FileInputStream(file)){
